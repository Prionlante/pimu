...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.corr1Box = QtWidgets.QComboBox(self.centralwidget)
        self.corr1Box.setObjectName("corr1Box")
        self.gridLayout.addWidget(self.corr1Box, 10, 0, 1, 1)
        ...
        self.corr2Box = QtWidgets.QComboBox(self.centralwidget)
        self.corr2Box.setObjectName("corr2Box")
        self.gridLayout.addWidget(self.corr2Box, 10, 1, 1, 1)
        ...
        self.openBd = QtWidgets.QPushButton(self.centralwidget)
        self.openBd.setObjectName("openBd")
        self.gridLayout.addWidget(self.openBd, 15, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.tableOutputExcel, 0, 3, 16, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "КОРРЕЛЯЦИЯ"))
        ...
        self.pushButton.setText(_translate("MainWindow", "Вывести корреляцию"))
        self.openBd.setText(_translate("MainWindow", "Открыть базу данных"))
